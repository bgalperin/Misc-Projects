...
ELSEIF LASTCMD = &H48 THEN ' H  -  R12
	GOSUB mechazilla_walk 'forward_walk
	WAIT
...
mechazilla_walk:
       MOVE G6D, 81,  76, 145,  93, 100, 100
       MOVE G6A,113,  77, 131,  94,  95,  96
       WAIT
       DELAY 2000
       
       MOVE G6A,113,  57, 145,  70,  93,  97
       MOVE G6D, 77,  14,  93,  88, 101,  93
       WAIT
       DELAY 2000
       
       MOVE G6A,121,  84, 126, 125,  96,  94
       WAIT
       DELAY 2000
       
       MOVE G6A, 85,  86, 129, 126, 127,  88
       MOVE G6D,115,  14,  93,  88,  71,  75
       WAIT
       DELAY 2000
       
       MOVE G6A, 69,  82, 163,  93, 119,  98
       WAIT
       DELAY 2000
       
       MOVE G6D,123,  93, 175,  81,  77,  98
       WAIT
       DELAY 2000      
RETURN